...
contract SupplyChain is Ownable, FarmerRole, ConsumerRole, RetailerRole, DistributorRole {
  ...
  // mapping (uint => string[]) itemsHistory; //TODO don't need to worry about it for now
  ...
  function harvestItem (
    ...
    Item memory newItem = Item (
      ...
      0, // Product Price
      defaultState,
      0,  // Metamask-Ethereum address of the Distributor
      0, // Metamask-Ethereum address of the Retailer
      0 // Metamask-Ethereum address of the Consumer
    ); 
    items[_upc] = newItem;
    // Increment sku
    sku_count = _sku;
